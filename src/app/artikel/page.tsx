    ...
    <main className="min-h-screen bg-[#f2f6fa]">
      ...
      <section className="bg-primary text-white pt-32 pb-16 md:pt-40 md:pb-24 relative overflow-hidden border-b-4 border-[#fbbf24]">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-md">Artikel Edukasi</h1>
          <p className="text-blue-100 max-w-2xl mx-auto text-lg drop-shadow-sm font-medium">Ikuti perkembangan terbaru dan informasi edukatif seputar program BI Mengajar di Kota Pematangsiantar.</p>
        </div>
      </section>
