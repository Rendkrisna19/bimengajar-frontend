            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="block text-xs font-bold text-slate-600 dark:text-gray-300 uppercase tracking-wider px-1">
                  Upload Gambar Artikel (Wajib Potong / Crop foto agar pas di Beranda)
                </label>
                <div className="relative w-full">
                  <input 
                    ...
                    onChange={async (e) => {
                      if (e.target.files && e.target.files.length > 0) {
                        ...
                        // Open cropper for the first selected file
                  ...
                  >
                    <i className="fa-solid fa-crop-simple text-sm text-sky-500"></i> Klik untuk Memilih &amp; Crop Gambar Artikel
                  </label>
                </div>
